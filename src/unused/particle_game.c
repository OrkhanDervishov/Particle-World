...
//     // if(CreateWorld(&((*game)->w))) return 1;
//     if(CreateChunkSpace(
//         (*game)->cs, CS_WIDTH, CS_HEIGHT, 
...
//             // DrawScene(win, sim, bgt, &bgrect, &bgrect);
//             // DrawSceneWithoutTexture(game);
//             // DrawCircle(game mx, my, RADIUS);
