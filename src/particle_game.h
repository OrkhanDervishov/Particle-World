...
#define PAUSE_GAME(g) (*g)->pause = TRUE
#define CONTINUE_GAME(g) (*g)->pause = FALSE
#define ENABLE_HEATMAP_MOD(g) (*g)->hm_mode = TRUE
#define DISABLE_HEATMAP_MOD(g) (*g)->hm_mode = FALSE
